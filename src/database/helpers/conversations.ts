 ...
 */
export async function addConversation(orm: D1Orm, address: string, name: string = 'New Conversation'): Promise<ConversationResult> {
	try {
 ...
 */
export async function updateConversation(orm: D1Orm, address: string, conversationId: number, name?: string): Promise<ConversationResult> {
	try {
		userConversationsModel.SetOrm(orm);
 ...
 */
export async function deleteConversation(orm: D1Orm, address: string, conversationId: number): Promise<ConversationResult> {
	try {
		userConversationsModel.SetOrm(orm);
 ...
 */
export async function getConversation(orm: D1Orm, conversationId: number): Promise<ConversationResult> {
	try {
		userConversationsModel.SetOrm(orm);
 ...
 * @throws Error if database query fails
 */
export async function getConversations(orm: D1Orm, address: string): Promise<ConversationResult> {
	try {
		userConversationsModel.SetOrm(orm);
 ...
 * @throws Error if database query fails
 */
export async function getLatestConversation(orm: D1Orm, address: string): Promise<ConversationResult> {
	try {
		userConversationsModel.SetOrm(orm);
		const result = await userConversationsModel.All({
			where: {
 ...
 * @throws Error if database query fails
 */
export async function getLatestConversationId(orm: D1Orm, address: string): Promise<{ id?: number; success: boolean; error?: string }> {
	try {
 ...
 * @throws Error if database query fails
 */
export async function getConversationHistory(orm: D1Orm, conversationId: number): Promise<ConversationHistoryResult> {
	try {
		userConversationsModel.SetOrm(orm);
		userCrewExecutionsModel.SetOrm(orm);
